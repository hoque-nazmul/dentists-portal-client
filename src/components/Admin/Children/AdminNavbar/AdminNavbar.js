...
const AdminNavbar = () => {
    return (
        <nav className="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <a className="navbar-brand" href="/doctorsDashboard">Dentists Portal</a><button className="btn btn-link btn-sm order-1 order-lg-0" id="sidebarToggle" href="/hello"><i className="fas fa-bars"></i></button>
